    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nick', models.CharField(default='Hummingbird', max_length=50, verbose_name='Ник пользователя')),
                ('tag', models.CharField(max_length=50, unique=True, verbose_name='Тег для поиска')),
                ('bio', models.TextField(blank=True, default='Newborn Hummingbird', null=True, verbose_name='Краткое описание')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_read_message', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='chats.Message', verbose_name='Последнее прочитанное сообщение')),
